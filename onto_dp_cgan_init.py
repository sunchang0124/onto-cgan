...
import numpy as np
from onto_cgan.synthesizers.onto_cgan import Onto_CGANSynthesizer

from onto_cgan.onto_base import Onto_BaseTabularModel


class Onto_CGANModel(Onto_BaseTabularModel):
...
class Onto_CGAN(Onto_CGANModel):
    ...
    _MODEL_CLASS = Onto_CGANSynthesizer
